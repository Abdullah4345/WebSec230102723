<nav class="navbar navbar-expand-sm navbar-dark navbar-custom">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('purchases_history')); ?>">Purchase History</a>
            </li>
            <li class="nav-item">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/WebSec230102723/WebSecService/resources/views/layouts/menu.blade.php ENDPATH**/ ?>